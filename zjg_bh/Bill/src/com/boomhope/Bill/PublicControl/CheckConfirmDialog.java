...
public class CheckConfirmDialog extends JDialog {
	...
	public CheckConfirmDialog(JFrame frame,boolean isModel,String Msg){
		super(frame);
		initiDialog(Msg);
	}
	/**
	...
	public void showDialog(String msg){
		final CheckConfirmDialog dialog=this;
		label.setText(setMsg(msg));
		//模式弹框必须在线程中打开负责会阻塞线程
	...
	public static void main(String[] args) throws InterruptedException {
		...
		final CheckConfirmDialog dialog=new CheckConfirmDialog(frame, true,"你好！*******************************");
		dialog.showDialog("");
