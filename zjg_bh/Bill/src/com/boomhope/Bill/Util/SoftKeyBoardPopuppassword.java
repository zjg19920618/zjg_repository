...
//软键盘弹出菜单  
public class SoftKeyBoardPopuppassword extends JPopupMenu {  
	static Logger logger = Logger.getLogger(SoftKeyBoardPopuppassword.class);
    ...
    public static void main(String[] args) {  
        ...
        final SoftKeyBoardPopuppassword keyPopup = new SoftKeyBoardPopuppassword(password,length);  
    ...
    public SoftKeyBoardPopuppassword(JPasswordField passwordField,int lengths) {  
    ...
    public static class SoftKeyBoardPanel extends JPanel implements ActionListener {  
        ...
        public SoftKeyBoardPanel(JPasswordField passwordField, JPopupMenu popupMenu) {  
            this.passwordField = passwordField;  
        ...
        public void actionPerformed(ActionEvent e) {  
            ...
            if (keyLable.isShift() || keyLable.isCapsLock()) {  
               ...
               JPasswordField a= clickCommKey(key,length);
...
//            return passwordField;
    	 ...
    	 * @return 
    	 */
    	private JPasswordField scanBill1(JPasswordField a){
        ...
        // 点击了普通的键，添加一个字符  
        public JPasswordField clickCommKey(String key,int length) {  
