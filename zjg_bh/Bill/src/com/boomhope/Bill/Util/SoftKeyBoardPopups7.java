...
public class SoftKeyBoardPopups7 extends JPopupMenu{
    ...
    public static void main(String[] args) {  
        ...
        final SoftKeyBoardPopups7 keyPopup = new SoftKeyBoardPopups7(password,5);  
        ...
        keyBoard.addMouseListener(new MouseAdapter() {  
            public void mouseClicked(MouseEvent e) {  
                if (!keyPopup.isVisible()) {  
                    ...
                    keyPopup.getsoftKeyBoardPanel7().reset();  
                    keyPopup.repaint();
    ...
    protected softKeyBoardPanel7 softKeyBoardPanel7;  
  
    public SoftKeyBoardPopups7(JTextField textField,int lengths) {  
        softKeyBoardPanel7 = new softKeyBoardPanel7(textField, this);  
        softKeyBoardPanel7.setBackground(Color.WHITE);
        softKeyBoardPanel7.setPreferredSize(new Dimension(350, 260));  
        softKeyBoardPanel7.setBorder(BorderFactory.createEmptyBorder());  
        length =lengths;
        add(softKeyBoardPanel7);  
        softKeyBoardPanel7.setLayout(new MigLayout("", "[]", "[]"));
    ...
    public softKeyBoardPanel7 getsoftKeyBoardPanel7() {  
        return softKeyBoardPanel7;  
    }  
  
    // 软键盘面板  
    public static class softKeyBoardPanel7 extends JPanel implements ActionListener {  
//    	private JTextField textField;
        ...
        public softKeyBoardPanel7(JTextField textField, JPopupMenu popupMenu) {  
        ...
        public class RowPanel extends JPanel {  
            ...
            private void initRowPanel() {  
                ...
                if (rowType == RowType.first) {  
                    ...
                    KeyLable key1 = new KeyLable("1", softKeyBoardPanel7.this);  
                    KeyLable key2 = new KeyLable("2", softKeyBoardPanel7.this);  
                    KeyLable key3 = new KeyLable("3", softKeyBoardPanel7.this);  
...
//                  } 
                  // key1至key10是一个闭环顺序，通过随机数决定在哪个位置切断这个环从而使其变成单链  
                  KeyLable key1 = new KeyLable("4", softKeyBoardPanel7.this);  
                  KeyLable key2 = new KeyLable("5", softKeyBoardPanel7.this);  
                  KeyLable key3 = new KeyLable("6", softKeyBoardPanel7.this);  
...
//                    this.add(key);  
//                } 
                KeyLable key1 = new KeyLable("7", softKeyBoardPanel7.this);  
                KeyLable key2 = new KeyLable("8", softKeyBoardPanel7.this);  
                KeyLable key3 = new KeyLable("9", softKeyBoardPanel7.this);  
//                KeyLable key4 = new KeyLable("f", SoftKeyBoardPanel.this);  
//                KeyLable key5 = new KeyLable("g", SoftKeyBoardPanel.this);  
//                KeyLable key6 = new KeyLable("h", SoftKeyBoardPanel.this);  
...
//                  this.add(key);  
//              } 
              KeyLable key1 = new KeyLable("-", softKeyBoardPanel7.this);  
              KeyLable key2 = new KeyLable("0", softKeyBoardPanel7.this);  
//              KeyLable key3 = new KeyLable("删除", SoftKeyBoardPanel.this);  
              KeyLable key3 = new KeyLable("删除", true, softKeyBoardPanel7.this);// 功能键，位置固定在最右  
