	...
	*/
	...
	private class JP1 extends JPanel {
		...
		private void initJP1() {
			...
			yearleft.setFont(new Font("宋体", Font.BOLD, 15));

			yearleft.setToolTipText("上一年");

			yearright = new JLabel(">>  ", JLabel.CENTER);
			
			yearright.setFont(new Font("宋体", Font.BOLD, 15));
			...
			monthleft.setFont(new Font("宋体", Font.BOLD, 15));

			monthleft.setToolTipText("上一月");

			monthright = new JLabel(">  ", JLabel.LEFT);
			
			monthright.setFont(new Font("宋体", Font.BOLD, 15));
			...
			center.setFont(new Font("宋体", Font.BOLD, 15));
			...
			this.setPreferredSize(new Dimension(378, 40));
	...
	private class JP2 extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			g.drawString("星期日 星期一 星期二 星期三 星期四 星期五 星期六", 5, 20);
	...
	private class JP3 extends JPanel {
		...
		public JP3() {
			...
			this.setPreferredSize(new Dimension(378,150));
