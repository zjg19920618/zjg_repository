...
public class SoftKeyBoardPopups2 extends JPopupMenu{
    ...
    public static void main(String[] args) {  
        ...
        final SoftKeyBoardPopups2 keyPopup = new SoftKeyBoardPopups2(password);  
    ...
    public SoftKeyBoardPopups2(JTextField textField) {  
