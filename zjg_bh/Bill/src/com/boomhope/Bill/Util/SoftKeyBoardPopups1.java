...
public class SoftKeyBoardPopups1 extends JPopupMenu{
    ...
    public static void main(String[] args) {  
        ...
        final SoftKeyBoardPopups1 keyPopup = new SoftKeyBoardPopups1(password);  
    ...
    public SoftKeyBoardPopups1(JTextField textField) {  
...
//                  this.add(key);  
//              } 
              KeyLable key1 = new KeyLable("X", SoftKeyBoardPanel.this);  
