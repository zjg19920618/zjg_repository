...
public class GuaLostAmtKeyBoardPop extends JPopupMenu{
    ...
    public static void main(String[] args) {  
        ...
        final GuaLostAmtKeyBoardPop keyPopup = new GuaLostAmtKeyBoardPop(password);  
    ...
    public GuaLostAmtKeyBoardPop(JTextField textField) {  
