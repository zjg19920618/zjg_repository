...
public class GuaLostSubAccKeyBoardPop extends JPopupMenu{
    ...
    public static void main(String[] args) {  
        ...
        final GuaLostSubAccKeyBoardPop keyPopup = new GuaLostSubAccKeyBoardPop(password,5);  
    ...
    public GuaLostSubAccKeyBoardPop(JTextField textField,int lengths) {  
