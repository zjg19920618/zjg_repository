...
//软键盘弹出菜单  
public class SoftKeyBoardPopups extends JPopupMenu {  
    ...
    public static void main(String[] args) {  
        ...
        final SoftKeyBoardPopups keyPopup = new SoftKeyBoardPopups(password,6);  
    ...
    public SoftKeyBoardPopups(JTextField textField,int lengths) {  
