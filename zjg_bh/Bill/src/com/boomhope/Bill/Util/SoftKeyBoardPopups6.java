...
import com.sun.glass.events.KeyEvent;
 //不加密全键盘 
//软键盘弹出菜单  
public class SoftKeyBoardPopups6 extends JPopupMenu {  
    ...
    public static void main(String[] args) {  
        ...
        final SoftKeyBoardPopups6 keyPopup = new SoftKeyBoardPopups6(password,6);  
    ...
    public SoftKeyBoardPopups6(JTextField textField,int lengths) {  
    	logger.info("没有切换按钮键盘类");
        ...
        public void actionPerformed(ActionEvent e) {  
            ...
            if (keyLable.isShift() || keyLable.isCapsLock()) {  
                ...
                if (keyLable.isShift()) {  
                	...
                	String key=keyLable.getCenterKey();
                	String lowKey=keyLable.getLowerLeftKey();
                	clickCapsLock(key);  
                } 
                pressed = !pressed;  
...
//         通知KeyLabel更新状态  
        ...
        // 更改状态  
        public void clickCapsLock(String key) { 
...
//                        this.add(key);  
//                    } 
                	 KeyLable key10 = new KeyLable("小 写 ","大 写", true,SoftKeyBoardPanel.this);  
...
//                    key11.setPreferredSize(new Dimension(60, 50));  
                    key8.setPreferredSize(new Dimension(60, 50));  
                    key9.setPreferredSize(new Dimension(60, 50));
                    key10.setPreferredSize(new Dimension(60, 50));  
                    key12.setPreferredSize(new Dimension(60, 50));  
                    keys = new KeyLable[] { key1, key2, key3, key4, key5, key6, key7, key8, key9, key10,key12 };  
                    ArrayList<KeyLable> keylist = new ArrayList<KeyLable>(keys.length);  
                      for (KeyLable key : keys) {  
                            keylist.add(key);  
                    }  
        ...
        public KeyLable(String centerKey, String lowerLeftKey, boolean isFunctionKey, final ActionListener action) {  
            ...
            if (isFunctionKey) {// 这个变量主要是提高效率  
                if (centerKey.indexOf("切") >= 0|| centerKey.indexOf("换") >= 0) {  
                	...
                	isCapsLock=true;
                }else if(centerKey.indexOf("小") >= 0 || centerKey.indexOf("写") >= 0){
                	isCapsLock=true;
                }
            }  
