...
//	/***
//	 * 已废弃，不在做扩展，统一使用getInputPassword方法
//	 * 输入密码
//	 * @param reqMap 请求map
//	 * 【请求map参数PassLength: 密码长度】
//	 * 【请求map参数EncType: 加密方式】 
//	 * 【请求map参数PinType: PIN运算算法】 
//	 * 【请求map参数PinFill: PIN补位方式】 
//	 * 【请求map参数CardNo: 卡号】
//	 * @return 响应map
//	 * 【响应map参数ResCode：返回代码(S-成功  F-失败)】
//	 * 【响应map参数ResMsg：返回信息(失败时返回)】
//	 * 【响应map参数Password: 密码密文】 
//	 * @throws IOException 
//	 * @throws UnknownHostException 
//	 */
//	public Map<String, String> inputPassword(BackTransBasePanel panel, Map<String, String> reqMap) throws UnknownHostException, IOException{
//		
//		
//		/* 生成请求报文 */
...
//		
//		/* 发送请求并接收驱动平台返回 */
//		String resMsg = new DriverClient().doInputPassword(panel, reqMsg);
//
//		/* 解析响应报文并写入Map返回 */
//		String[] res = resMsg.split("\\|");
//		Map<String, String> resMap = new HashMap<String, String>();
...
//	 * @throws IOException
//	 */
//	public String getKnowArticle(BackTransBasePanel panel,String transCode,String pwdLength) throws UnknownHostException, IOException {
//		BackTransFirstCardNo backTransFirstCardNo = null;
//		BackTransAgainCardNo backTransAgainCardNo = null;
...
//		if(panel instanceof BackTransFirstCardNo){
//			backTransFirstCardNo = (BackTransFirstCardNo)panel;
//		}
//		if(panel instanceof BackTransAgainCardNo){
//			backTransAgainCardNo = (BackTransAgainCardNo)panel;
//		}
//		//构建IO  
//		OutputStream os = socket.getOutputStream(); 
//		os.write(reqMsg.getBytes());
...
//					if(backTransFirstCardNo != null){
//						String text = backTransFirstCardNo.textField.getText() + res[3].substring(1);
//						backTransFirstCardNo.textField.setText(text);
//					}
//					if(backTransAgainCardNo != null){
//						String text = backTransAgainCardNo.textField.getText() + res[3].substring(1);
//						backTransAgainCardNo.textField.setText(text);
//					}
//					
...
//					/* 用户点击退格，删除最后一个密码字符 */
//					if(backTransFirstCardNo != null){
//						String text = backTransFirstCardNo.textField.getText();
//						if(text.length()>0){
...
//					}
//					if(backTransAgainCardNo != null){
//						String text = backTransAgainCardNo.textField.getText();
//						if(text.length()>0){
//							text = text.substring(0, text.length()-1);
//						}
//						backTransAgainCardNo.textField.setText(text);
...
//	 * @throws IOException
//	 */
//	public String getKnowBillNo(BackTransBasePanel panel,String transCode,String pwdLength) throws UnknownHostException, IOException {
//		DepositCertificatePanel depositCertificatePanel = null;
//		if(Integer.parseInt(transCode) <= 0){
//			return null;
//		}
//		String reqMsg = getMsgHead(transCode);
...
//		OutputStream os = socket.getOutputStream(); 
//		os.write(reqMsg.getBytes());
//		if(panel instanceof DepositCertificatePanel){
//			depositCertificatePanel = (DepositCertificatePanel)panel;
//		}
//		while (true){
//			InputStream is = socket.getInputStream();  
//			byte[] buffer = new byte[1024];
...
//				String[] res = resMsg.split("\\|");
//				if(res[3].startsWith("3")){
//					if(depositCertificatePanel != null){
//						String text = depositCertificatePanel.textField1.getText() + res[3].substring(1);
//						depositCertificatePanel.textField1.setText(text);
//					}
//					
//				}else if (res[3].equals("1B")){
//					break;
...
//					/* 用户点击退格，删除最后一个密码字符 */
//					if(depositCertificatePanel != null){
//						String text = depositCertificatePanel.textField1.getText();
//						if(text.length()>0){
//							text = text.substring(0, text.length()-1);
//						}
//						depositCertificatePanel.textField1.setText(text);
...
//	 * @throws IOException
//	 */
//	public String getKnowBillCertNo(BackTransBasePanel panel,String transCode,String pwdLength) throws UnknownHostException, IOException {
//		DepositCertificatePanel depositCertificatePanel = null;
//		if(Integer.parseInt(transCode) <= 0){
//			return null;
//		}
...
//				if(res[3].startsWith("3")){
//					if(depositCertificatePanel != null){
//						String text = depositCertificatePanel.textField2.getText() + res[3].substring(1);
//						depositCertificatePanel.textField2.setText(text);
//					}
//					
//				}else if (res[3].equals("1B")){
//					break;
...
//					/* 用户点击退格，删除最后一个密码字符 */
//					if(depositCertificatePanel != null){
//						String text = depositCertificatePanel.textField2.getText();
//						if(text.length()>0){
//							text = text.substring(0, text.length()-1);
//						}
//						depositCertificatePanel.textField2.setText(text);
...
//	}
	 ...
	 * 
	 * @param panel          放this页面，该页面必须继承BaseTransPanelNew类
	 ...
	 * @throws IOException
	 */
	public String getDoInputPassword(BaseTransPanelNew panel,String propertyStr,String nextStep, String reqMsg) throws Exception{
		Class clazz = (Class)panel.getClass();
		Field field = clazz.getDeclaredField(propertyStr);
		field.setAccessible(true);
		System.out.println("reqMsg:" + reqMsg);
		...
		try {
			...
			Method m = clazz.getMethod("get"+upperHeadChar(field.getName()));//
			Object object = m.invoke(panel);//取出属性
	        JTextField jTextField =(JTextField)object;
	        jTextField.setText("");
	        String text = jTextField.getText();//取属性值
			while (true){
				...
				if (res[3].equals("*")){
					...
					return getDoInputPassword(panel,propertyStr,nextStep,reqMsg);
				}else if (res[3].equals("FF")){
					text="";
					jTextField.setText("");
				}else if (res[3].equals("0D")){
