 ...
 *
 */
public class BillChangeOpenFaceCheckFail extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	
	Logger logger = Logger.getLogger(BillChangeOpenFaceCheckFail.class);
	
	public BillChangeOpenFaceCheckFail(String serStopMsg,String errMsg) {
		/*显示时间倒计时*/
		...
		step.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				//清空倒计时和语音
				clearTimeText();
				bcOpenBean.setCameraCount(String.valueOf(Integer.parseInt(bcOpenBean.getCameraCount())+1));
