 ...
 *
 */
public class BillChangeOpenAuthorFingerprintJwPanel extends BaseTransPanelNew{

	static Logger logger = Logger.getLogger(BillChangeOpenAuthorFingerprintJwPanel.class);
	 ...
	 * 初始化
	 */
	public BillChangeOpenAuthorFingerprintJwPanel() {
		/*显示时间倒计时*/
