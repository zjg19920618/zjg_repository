 ...
 *
 */
public class BillChangeOpenAgentPoliceCheckPanel extends BaseTransPanelNew {
	static Logger logger = Logger.getLogger(BillChangeOpenAgentPoliceCheckPanel.class);
	private static final long serialVersionUID = 1L;
	private Component comp;
	
	public BillChangeOpenAgentPoliceCheckPanel() {
		comp = this;
		/*显示时间倒计时*/
		...
		voiceTimer.start();
		// 标题
		JLabel depoLum = new JLabel("代理人身份核查中,请稍候......");
	...
	public void agentcheck(){
		...
		new Thread(new Runnable() {
			...
			public void run() {
				clearTimeText();
				//代理人身份核查
				bcOpenAction.agentPolicecheck(comp);
			}
		}).start();
	}
