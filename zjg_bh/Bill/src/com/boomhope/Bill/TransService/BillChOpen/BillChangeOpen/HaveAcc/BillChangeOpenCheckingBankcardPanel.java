...
public class BillChangeOpenCheckingBankcardPanel extends BaseTransPanelNew{
	
	static Logger logger = Logger.getLogger(BillChangeOpenCheckingBankcardPanel.class);
	private Component comp;
	
	public BillChangeOpenCheckingBankcardPanel(){
	...
	public void check(){
		...
		new Thread(new Runnable() {
			...
			public void run() {
				clearTimeText();
				//进入密码输入页面
				openPanel(comp,new BillChangeOpensubAccBankorBillPassPanel());
			}
		}).start();
	}
}
