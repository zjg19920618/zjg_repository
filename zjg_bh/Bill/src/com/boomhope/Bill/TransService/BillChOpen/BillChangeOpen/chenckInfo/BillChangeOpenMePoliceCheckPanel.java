 ...
 *
 */
public class BillChangeOpenMePoliceCheckPanel extends BaseTransPanelNew {
	static Logger logger = Logger.getLogger(BillChangeOpenMePoliceCheckPanel.class);
	private static final long serialVersionUID = 1L;
	private Component comp;
	
	public BillChangeOpenMePoliceCheckPanel() {
		comp = this;
		/*显示时间倒计时*/
	...
	public void mecheck(){
		...
		new Thread(new Runnable() {
			...
			public void run() {
				clearTimeText();
				//本人身份核查
				bcOpenAction.mePolicecheck(comp);
			}
		}).start();
	}
