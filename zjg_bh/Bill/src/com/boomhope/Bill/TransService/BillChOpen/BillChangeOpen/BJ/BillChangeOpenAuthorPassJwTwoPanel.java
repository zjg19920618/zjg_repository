 ...
 *
 */
public class BillChangeOpenAuthorPassJwTwoPanel extends BaseTransPanelNew{

	static Logger logger = Logger.getLogger(BillChangeOpenAuthorPassJwTwoPanel.class);
	 ...
	 * 初始化
	 */
	public BillChangeOpenAuthorPassJwTwoPanel() {
		...
		errInfo = new JLabel("提示：请录入授权柜员密码!");
