 ...
 * @author hao 
 */
public class BillChangeOpenCameraPanel extends BaseTransPanelNew {
	static Logger logger = Logger.getLogger(BillChangeOpenCameraPanel.class);
	...
	public BillChangeOpenCameraPanel() {
		logger.info("进入拍照页面");
		...
		if(bcOpenBean.getCameraCount()==null ||"".equals(bcOpenBean.getCameraCount())){
			bcOpenBean.setCameraCount("0");
		}
		...
		submitBtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				}else if("1".equals(bcOpenBean.getHavAgentFlag())){//有代理人
	...
	public void pz() {
		try {
			...
			logger.error("拍照失败："+e);
			player.close();
			openPanel(new BillChangeOpenFaceCheckFail("拍照失败，请联系大堂经理", ""));
		}		
	}
	...
	public void nextStep(){
		...
		//页面跳转
		openPanel(new BillChangeOpenFaceCheckPanel());
	}
