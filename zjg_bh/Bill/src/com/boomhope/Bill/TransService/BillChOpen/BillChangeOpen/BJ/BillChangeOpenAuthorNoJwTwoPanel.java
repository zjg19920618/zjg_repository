...
/***
 * 
 * 鉴伪不通过，金额小于10万,录入一个授权柜员号
 * @author zjg
 *
 */
public class BillChangeOpenAuthorNoJwTwoPanel extends BaseTransPanelNew {

	static Logger logger = Logger.getLogger(BillChangeOpenAuthorNoJwTwoPanel.class);
	 ...
	 * 初始化
	 */
	public BillChangeOpenAuthorNoJwTwoPanel() {
		/*显示时间倒计时*/
		...
		/* 标题信息 */
		JLabel titleLabel = new JLabel("请录入授权柜员!");
	...
	private void authorDeal( final String checkMod) {
		...
		if ("1".equals(checkMod)) {// 1 口令2 指纹
			...
			openPanel(new BillChangeOpenAuthorPassJwTwoPanel());
		} else {
