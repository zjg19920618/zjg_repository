 ...
 *
 */
public class BillChangeOpenCheckTFFailPanel extends BaseTransPanelNew {
	static Logger logger = Logger.getLogger(BillChangeOpenCheckTFFailPanel.class);
	private static final long serialVersionUID = 1L;
	private boolean on_off=true;//用于控制页面跳转的开关
	JLabel depoLum ;
	public BillChangeOpenCheckTFFailPanel(String msg) {
		/*显示时间倒计时*/
		...
		add(label_3);
		    ...
		    //插卡流水换开
			JLabel label_4 = new JLabel(new ImageIcon("pic/pingcardhk.png"));
			label_4.setBounds(520, 770, 150, 50);
