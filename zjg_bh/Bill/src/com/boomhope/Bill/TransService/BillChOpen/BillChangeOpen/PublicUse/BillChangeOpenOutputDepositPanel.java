 ...
 * 
 */
public class BillChangeOpenOutputDepositPanel extends BaseTransPanelNew {
	final int voiceSecond = 500;
	UtilVoice utilVoice = null;
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(BillChangeOpenOutputDepositPanel.class);

	public BillChangeOpenOutputDepositPanel() {
		/*显示时间倒计时*/
