 ...
 *
 */
public class BillChangeOpenInputDepositPanel extends BaseTransPanelNew {
	private static final long serialVersionUID = 1L;
	private boolean cundan = false;
	static Logger logger = Logger.getLogger(BillChangeOpenInputDepositPanel.class);
	public BillChangeOpenInputDepositPanel() {
			...
			public void run() {
				...
				try {
					...
					if (Dispatch.call(BaseLoginFrame.dispath, "BH_WaitInsert",new Variant("0"), new Variant("0")).getInt() == 0) {
		            	...
		            	//跳转存单鉴伪处理页
		            	openPanel(new BillChangeOpenCheckTFPanel());
