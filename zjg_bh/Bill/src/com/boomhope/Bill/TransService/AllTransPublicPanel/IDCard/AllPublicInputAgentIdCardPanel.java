...
public class AllPublicInputAgentIdCardPanel extends BaseTransPanelNew {
	Thread thread = null;
	static Logger logger = Logger.getLogger(AllPublicInputAgentIdCardPanel.class);
	IdCardReadBean bean = null;
	SourceDataLine line = null;
	JButton button = null;
	private static final long serialVersionUID = 1L;

	public AllPublicInputAgentIdCardPanel() {
	...
	public void readIdCard() {
		...
		thread = new Thread("readIdCard") {
			...
			public void run() {
        		...
        		if("0".equals(status)){
        			// 成功
        			baseTransBean.setAllPubAgentIDCardReadInfo(bean);
