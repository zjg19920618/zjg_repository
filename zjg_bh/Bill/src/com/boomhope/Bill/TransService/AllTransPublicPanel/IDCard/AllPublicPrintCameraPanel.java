...
public class AllPublicPrintCameraPanel extends BaseTransPanelNew {
	static Logger logger = Logger.getLogger(AllPublicPrintCameraPanel.class);
	...
	public AllPublicPrintCameraPanel(){
		logger.info("进入拍照页面");
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					Thread.sleep(1500);//等待1.5秒关闭等待框，让摄像头启动完整
