 ...
 *
 */
public class SignaturePanel extends BaseTransPanelNew {
	
	static Logger logger = Logger.getLogger(SignaturePanel.class);
	/*倒计时时间*/
	JLabel lblNewLabel;
	JLabel promptLabel;
	...
	public SignaturePanel(final PublicAccTransferBean transferBean){
	...
	private void okNext(){
		...
		try {
			screen.Screenshot(515, 280, panel.getWidth(), panel.getHeight(), Property.SIGNATURE_PATH);
