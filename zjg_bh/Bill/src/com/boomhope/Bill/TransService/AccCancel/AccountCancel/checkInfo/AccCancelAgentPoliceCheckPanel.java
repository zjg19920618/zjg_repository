 ...
 *
 */
public class AccCancelAgentPoliceCheckPanel extends BaseTransPanelNew {
	static Logger logger = Logger.getLogger(AccCancelAgentPoliceCheckPanel.class);
	private static final long serialVersionUID = 1L;
	private Component comp;
	
	public AccCancelAgentPoliceCheckPanel() {
		comp = this;
		/*显示时间倒计时*/
	...
	public void agentcheck(){
		...
		new Thread(new Runnable() {
			...
			public void run() {
				clearTimeText();
				//代理人身份核查
				noAccAction.agentPolicecheck(comp);
			}
		}).start();
	}
