...
/**
 * 鉴伪通过，金额大于等于10万,主管鉴别存单真伪,录入授权密码
 * @author gyw
 *
 */
public class AccCancelAuthorPassBJPanel extends BaseTransPanelNew{

	static Logger logger = Logger.getLogger(AccCancelAuthorPassBJPanel.class);
	 ...
	 * 初始化
	 */
	public AccCancelAuthorPassBJPanel() {
