 ...
 *
 */
public class AccCancelAuthorFingerprintPanel extends BaseTransPanelNew{

	static Logger logger = Logger.getLogger(AccCancelAuthorFingerprintPanel.class);
	 ...
	 * 初始化
	 */
	public AccCancelAuthorFingerprintPanel() {
		//将当前页面传入流程控制进行操作
