 ...
 *
 */
public class AccCancelInputDepositPanels extends BaseTransPanelNew {
	
	private static final long serialVersionUID = 1L;
	private boolean cundan = false;
	static Logger logger = Logger.getLogger(AccCancelInputDepositPanels.class);
	private String billImgPath;//扫描图片路径
	
	public AccCancelInputDepositPanels() {
