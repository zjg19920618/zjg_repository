 ...
 *
 */
public class AccCancelAuthorFingerprintJwTwoPanel extends BaseTransPanelNew{

	static Logger logger = Logger.getLogger(AccCancelAuthorFingerprintJwTwoPanel.class);
	 ...
	 * 初始化
	 */
	public AccCancelAuthorFingerprintJwTwoPanel() {
		/*显示时间倒计时*/
					...
					if(!IntefaceSendMsg.SUCCESS.equals(resCode)){
						...
						confirmDialog.YseButten.addMouseListener(new MouseAdapter() {
							...
							public void mouseReleased(MouseEvent e) {
								...
								closeVoice();
								closeDialog(confirmDialog);
								openPanel(new AccCancelAuthorFingerprintJwTwoPanel());
							}
						});
						confirmDialog.Nobutton.addMouseListener(new MouseAdapter() {
							@Override
