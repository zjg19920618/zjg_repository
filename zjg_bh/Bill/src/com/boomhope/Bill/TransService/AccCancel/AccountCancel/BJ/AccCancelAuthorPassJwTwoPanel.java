 ...
 *
 */
public class AccCancelAuthorPassJwTwoPanel extends BaseTransPanelNew{

	static Logger logger = Logger.getLogger(AccCancelAuthorPassJwTwoPanel.class);
	 ...
	 * 初始化
	 */
	public AccCancelAuthorPassJwTwoPanel() {
