 ...
 *
 */
public class AccCancelAuthorFingerprintJwPanel extends BaseTransPanelNew{

	static Logger logger = Logger.getLogger(AccCancelAuthorFingerprintJwPanel.class);
	 ...
	 * 初始化
	 */
	public AccCancelAuthorFingerprintJwPanel() {
		/*显示时间倒计时*/
