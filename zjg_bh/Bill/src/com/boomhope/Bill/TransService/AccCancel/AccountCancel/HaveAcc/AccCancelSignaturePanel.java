 ...
 *
 */
public class AccCancelSignaturePanel extends BaseTransPanelNew {
	
	static Logger logger = Logger.getLogger(AccCancelSignaturePanel.class);
	/*倒计时时间*/
	JLabel lblNewLabel;
	JLabel promptLabel;
	...
	public AccCancelSignaturePanel(){
		setLayout(null);
		//流程
	...
	public void nextStep(){
		...
		on_off=false;
		clearTimeText();
		accCancelBean.setXHBankMsgIsSign("Y");
