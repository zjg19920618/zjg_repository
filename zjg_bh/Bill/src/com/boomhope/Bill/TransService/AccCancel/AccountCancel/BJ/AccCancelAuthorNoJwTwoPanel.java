 ...
 *
 */
public class AccCancelAuthorNoJwTwoPanel extends BaseTransPanelNew {

	static Logger logger = Logger.getLogger(AccCancelAuthorNoJwTwoPanel.class);
	 ...
	 * 初始化
	 */
	public AccCancelAuthorNoJwTwoPanel() {
		/*显示时间倒计时*/
	...
	private void authorDeal( final String checkMod) {
		...
		if ("1".equals(checkMod)) {// 1 口令2 指纹
			...
			openPanel(new AccCancelAuthorPassJwTwoPanel());
		} else {
