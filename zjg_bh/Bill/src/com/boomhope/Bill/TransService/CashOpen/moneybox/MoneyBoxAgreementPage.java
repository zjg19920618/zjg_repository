 ...
 *
 */
public class MoneyBoxAgreementPage extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxAgreementPage.class);

	JLabel lblNewLabel = null;
	JButton backButton=null;
	JButton backButton1=null;
	JButton backButton2=null;
	JButton backButton3=null;
	String change ="1";
	 int n=10;
	...
	public MoneyBoxAgreementPage(final PublicCashOpenBean transBean) {
		...
		if(transBean.getAgreementIdentification().equals("1")){
         ...
         if(transBean.getAgreementIdentification().equals("2")){
     	    lblNewLabel = new JLabel("<html><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"
		...
		if(transBean.getAgreementIdentification().equals("3")){
		    lblNewLabel = new JLabel("<html><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"
		...
		if(transBean.getAgreementIdentification().equals("4")){
		...
		if(transBean.getAgreementIdentification().equals("5")){
		    lblNewLabel = new JLabel("<html><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"
		...
		if(transBean.getAgreementIdentification().equals("6")){
		    lblNewLabel = new JLabel("<html><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"
      ...
      if(transBean.getAgreementIdentification().equals("7")){
  	    lblNewLabel = new JLabel("<html><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"
      ...
      if(transBean.getAgreementIdentification().equals("8")){
    	    lblNewLabel = new JLabel("<html><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp"
	    ...
	    backButton2.setLocation(95, 453);
	    ...
	    backButton3.setLocation(95, 453);
	   ...
	   lblNewLabel_3.setForeground(Color.BLACK);
		...
		t= new Timer(n*100, new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				updateTimeText();
			}
		});
