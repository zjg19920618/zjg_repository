 ...
 *
 */
public class MoneyBoxSHQXXLpanel extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxSHQXXLpanel.class);
	private boolean on_off=true;//开关控制
	public MoneyBoxSHQXXLpanel(final PublicCashOpenBean  transBean){
		this.cashBean = transBean;
		 Object[][] data = { { "王尼玛1", "123456", "1122", "1122"},{"张全蛋2","555","245", "1122"},{"张全蛋3","555","245", "1122"},{"张全蛋4","555","245", "1122"},{"张全蛋5","555","245", "1122"},{ "王尼玛6", "123456", "1122", "1122"},{"张全蛋7","555","245", "1122"},{"张全蛋8","555","245", "1122"},{"张全蛋9","555","245", "1122"},{"张全蛋10","555","245", "1122"}};
			...
			int z1 = a / 6;
			if (z != 0) {
				transBean.setSkhqxpage(z1 + 1);
				logger.debug(z1 + 1);
			} else {
				transBean.setSkhqxpage(z1);
				logger.debug(z1);
			}
...
//				openPanel(GlobalPanelFlag.INPUT_DEPINFO_PANEL);
	...
	public void  upStep(PublicCashOpenBean transBean){
		 int n =transBean.getSkhqxn();
     if (n==0){
    	transBean.setSkhqxn(0);
     }else{
    	 transBean.setSkhqxn(n-1);
     }
	...
	private void test(PublicCashOpenBean transBean) {
		clearTimeText();
		openPanel(new MoneyBoxEnteringSHQXXLPanel(transBean));
