 ...
 *
 */
public class MoneyBoxEnteringSHAXCPanel extends BaseTransPanelNew {
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxEnteringSHAXCPanel.class);
	...
	public MoneyBoxEnteringSHAXCPanel(final PublicCashOpenBean  transBean) {
