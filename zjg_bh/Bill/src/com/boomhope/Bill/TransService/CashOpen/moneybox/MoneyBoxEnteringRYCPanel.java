 ...
 *
 */
public class MoneyBoxEnteringRYCPanel extends BaseTransPanelNew {
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxEnteringRYCPanel.class);
	...
	public MoneyBoxEnteringRYCPanel(final PublicCashOpenBean  transBean) {
