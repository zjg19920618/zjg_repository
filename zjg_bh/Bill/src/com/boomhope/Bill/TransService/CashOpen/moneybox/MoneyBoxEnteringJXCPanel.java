 ...
 *
 */
public class MoneyBoxEnteringJXCPanel extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxEnteringJXCPanel.class);
	JLabel promptLabel;
	...
	public MoneyBoxEnteringJXCPanel(final PublicCashOpenBean transBean) {
...
//		add(lblNewLabel_7);
		...
		lblNewLabel_8.setBounds(651, 292, 125, 40);
