 ...
 *
 */
public class MoneyBoxEnteringAXCPanel extends BaseTransPanelNew {
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxEnteringAXCPanel.class);
	...
	public MoneyBoxEnteringAXCPanel(final PublicCashOpenBean transBean) {
...
//		add(label_6);
		...
		button_4.setBounds(180, 505, 90,40);
...
//		this.add(backButton1);
		...
		confirm.setBounds(890, 770, 150, 50);
