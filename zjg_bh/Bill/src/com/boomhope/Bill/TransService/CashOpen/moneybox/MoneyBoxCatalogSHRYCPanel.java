 ...
 *
 */
public class MoneyBoxCatalogSHRYCPanel extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxCatalogSHRYCPanel.class);
	...
	public MoneyBoxCatalogSHRYCPanel(final PublicCashOpenBean transBean){
...
//				test();
		...
		lblNewLabel_8.setBounds(10, 23, 79, 20);
		...
		for (int i = 1 + 6 * transBean.getN() - 6 * transBean.getX(); i < 2
			...
			lblNewLabel_15.setBounds(95, 101, 195, 20);
...
//				test();
		...
		for (int i = 2 + 6 * transBean.getN() - 6 * transBean.getX(); i < 3
			...
			lblNewLabel_17.setBounds(91, 22, 215, 20);
		...
		for (int i = 2 + 6 * transBean.getN() - 6 * transBean.getX(); i < 3
			...
			lblNewLabel_19.setBounds(91, 47, 215, 20);
...
//				test();
		...
		lblNewLabel_30.setBounds(10, 98, 79, 20);
...
//				test();
		...
		for (int i = 4 + 6 * transBean.getN() - 6 * transBean.getX(); i < 5
			...
			lblNewLabel_33.setBounds(100, 23, 215, 20);
		...
		for (int i = 4 + 6 * transBean.getN() - 6 * transBean.getX(); i < 5
			...
			lblNewLabel_35.setBounds(100, 49, 215, 20);
...
//				test();
		...
		lblNewLabel_40.setBounds(10, 22, 80, 20);
