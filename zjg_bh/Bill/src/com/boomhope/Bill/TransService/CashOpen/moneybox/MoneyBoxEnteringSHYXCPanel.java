 ...
 *
 */
public class MoneyBoxEnteringSHYXCPanel extends BaseTransPanelNew {
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxEnteringSHYXCPanel.class);
	...
	public MoneyBoxEnteringSHYXCPanel(final PublicCashOpenBean transBean) {
		...
		lblNewLabel_3.setBounds(651, 525, 120, 40);
