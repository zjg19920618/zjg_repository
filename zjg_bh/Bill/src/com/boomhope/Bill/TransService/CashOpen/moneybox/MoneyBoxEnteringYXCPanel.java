 ...
 *
 */
public class MoneyBoxEnteringYXCPanel extends BaseTransPanelNew {
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxEnteringYXCPanel.class);
	...
	public MoneyBoxEnteringYXCPanel(final PublicCashOpenBean  transBean) {
