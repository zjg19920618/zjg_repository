 ...
 *
 */
public class MoneyBoxEnteringSHQXXLPanel extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxEnteringSHQXXLPanel.class);
	JLabel promptLabel;
	...
	public MoneyBoxEnteringSHQXXLPanel(final PublicCashOpenBean transBean) {
