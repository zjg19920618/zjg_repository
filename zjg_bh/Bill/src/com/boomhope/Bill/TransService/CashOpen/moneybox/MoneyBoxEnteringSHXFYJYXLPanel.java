 ...
 *
 */
public class MoneyBoxEnteringSHXFYJYXLPanel extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(MoneyBoxEnteringSHXFYJYXLPanel.class);
	JLabel promptLabel;
	...
	public MoneyBoxEnteringSHXFYJYXLPanel(final PublicCashOpenBean transBean) {
