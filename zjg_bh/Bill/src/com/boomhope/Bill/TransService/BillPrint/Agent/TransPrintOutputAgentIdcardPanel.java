 ...
 *
 */
public class TransPrintOutputAgentIdcardPanel extends BaseTransPanelNew {
	//final int delaySecond = 120;
	final int voiceSecond = 500;
	UtilVoice utilVoice = null;
	SourceDataLine line = null;
	AudioStream as = null;
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(TransPrintOutputAgentIdcardPanel.class);
	
	public TransPrintOutputAgentIdcardPanel(final BillPrintBean transBean) {
		logger.info("进入退出代理人身份证页面");
	...
	public void nextStep(BillPrintBean transBean){
		...
		clearTimeText();
		// 进入代理人核查
		openPanel(new TransPrintCheckingAgentIdcardPanel(transBean));
	}
	/**关闭led灯*/
