 ...
 */
@Number(id = 1)
public class SearchProducRateInfo
{
	
	static Logger logger = Logger.getLogger(SearchProducRateInfo.class);
//	产品代码||金额||存期||档次||利率||支取月||窗口开始日期||窗口结束日期||锁定期开始日期||锁定期结束日期
	...
	//显示窗口期，但是不显示利率
	public StringBuffer getL51Str2(){
		StringBuffer savingCountStr=getSavingCountStr();
		if(savingCountStr.toString().trim().length()!=0){
	...
	public SearchProducRateInfo setProductCode(String productCode)
	{
	...
	public SearchProducRateInfo setMoney(String money)
	{
		this.money = money;
		return this;
	}
	...
	public SearchProducRateInfo setLevel(String level)
	{
		this.level = level;
		return this;
	}
	...
	public SearchProducRateInfo setSavingCount(String savingCount)
	{
	...
	public SearchProducRateInfo setRate(String rate)
	{
		this.rate = rate;
		return this;
	}
	...
	public SearchProducRateInfo setDrawMonth(String drawMonth)
	{
	...
	public SearchProducRateInfo setBenDateStr(String benDateStr)
	{
	...
	public SearchProducRateInfo setEndDateStr(String endDateStr)
	{
