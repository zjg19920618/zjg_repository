...
public class SetPwdFaceCheckFailPanel  extends BaseTransPanelNew{

	/**
	 * 人脸识别失败
	 */
	private static final long serialVersionUID = 1L;
	Logger logger = Logger.getLogger(SetPwdFaceCheckFailPanel.class);
	public SetPwdFaceCheckFailPanel(String serStopMsg,String errMsg) {
		/*显示时间倒计时*/
		...
		step.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				closeVoice();
				addPwdBean.setCameraCount(String.valueOf(Integer.parseInt(addPwdBean.getCameraCount())+1));
