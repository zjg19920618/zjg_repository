 ...
 * 签字板 
 */
public class SetPwdSignaturePanel extends BaseTransPanelNew{

	static Logger logger = Logger.getLogger(SetPwdSignaturePanel.class);
	private static final long serialVersionUID = 1L;

	JLabel lblNewLabel;
	JLabel promptLabel;
	SignatureUtil panel;
	public SetPwdSignaturePanel(){
		setLayout(null);
		//流程
