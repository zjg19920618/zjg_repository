...
public class SetPwdFaceCheckPanel extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(SetPwdFaceCheckPanel.class);
      public SetPwdFaceCheckPanel() {
  		...
  		new Thread("人脸识别线程") {
  			public void run() {
  				...
  				if (result == null || "-1".equals(result)) {
  					...
  					addPwdBean.getReqMCM001().setIntereturnmsg("人脸识别系统连接异常");
  				...
  				if (r.equals("0")) {
  	            	...
  	            	closeVoice();//关闭语音流
  					openPanel(new SetPwdFaceCheckFailPanel("人脸识别失败:"+exMsg+",请联系大堂经理", ""));
  					return;
  				}
  				...
  				if (sim >= defaultSim) {//sim >= defaultSim
  					...
  					addPwdBean.setFaceCompareVal(sims);
  					//跳入下一页
  					clearTimeText();//清空倒计时
  					stopTimer(voiceTimer);//关闭语音
  	            	closeVoice();//关闭语音流
  					...
  					stopTimer(voiceTimer);//关闭语音
  	            	closeVoice();//关闭语音流
  					openPanel(new SetPwdFaceCheckFailPanel("人脸识别未通过，请联系大堂经理", ""));
  				}
