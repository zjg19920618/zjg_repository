 ...
 *
 */
public class SetPwdAmtOverrunPanel extends BaseTransPanelNew{
	static Logger logger = Logger.getLogger(SetPwdAmtOverrunPanel.class);
	private static final long serialVersionUID = 1L;
	private boolean on_off=true;//用于控制页面跳转的开关
	JLabel depoLum ;
	public SetPwdAmtOverrunPanel(String msg) {
		         // 标题
				...
				trueButton.addMouseListener(new MouseAdapter() {
					...
					public void mouseReleased(MouseEvent e) {
		        		...
		        		Float addPwdlAmt = Float.valueOf(amt);
