 ...
 * 鉴伪失败 小于10万，录入授权柜员密码
 */
public class SetPwdAuthorOnePassPanel extends BaseTransPanelNew{
	static Logger logger = Logger.getLogger(SetPwdAuthorOnePassPanel.class);
	 ...
	 * 初始化
	 */
	public SetPwdAuthorOnePassPanel() {
		...
		submitBtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				openPanel(new SetPwdAuthroNoOnePanel());
			}
		});
		...
		new Thread(){
			...
			public void run() {
				...
				try {
					...
					addPwdBean.getReqMCM001().setReqBefor("77017");
