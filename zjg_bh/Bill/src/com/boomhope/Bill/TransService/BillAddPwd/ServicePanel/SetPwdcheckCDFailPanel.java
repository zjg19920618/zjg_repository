 ...
 *
 */
public class SetPwdcheckCDFailPanel extends BaseTransPanelNew{

	private static final long serialVersionUID = 1L;
     
	static Logger logger = Logger.getLogger(SetPwdcheckCDFailPanel.class);
	
	private boolean on_off=true;//用于控制页面跳转的开关
	JLabel depoLum ;
	public SetPwdcheckCDFailPanel(String msg) {
		/*显示时间倒计时*/
