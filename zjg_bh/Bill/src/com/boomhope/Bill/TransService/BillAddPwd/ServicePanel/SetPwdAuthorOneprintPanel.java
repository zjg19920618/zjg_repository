 ...
 * 鉴别真伪失败  小于10万  柜员录入指纹
 */
public class SetPwdAuthorOneprintPanel extends BaseTransPanelNew{

	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(SetPwdAuthorOneprintPanel.class);
	 ...
	 * 初始化
	 */
	public SetPwdAuthorOneprintPanel() {
		/*显示时间倒计时*/
