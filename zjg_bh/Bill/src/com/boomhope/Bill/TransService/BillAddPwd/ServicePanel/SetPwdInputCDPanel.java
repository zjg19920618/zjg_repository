 ...
 *
 */
public class SetPwdInputCDPanel extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	private boolean cundan = false;
	static Logger logger = Logger.getLogger(SetPwdInputCDPanel.class);
	
	public SetPwdInputCDPanel(){
		//设置开关
			...
			public void run() {
				...
				try {
					...
					if (Dispatch.call(BaseLoginFrame.dispath, "BH_WaitInsert",new Variant("0"), new Variant("0")).getInt() == 0) {
		            	...
		            	//跳转存单鉴伪处理页
		            	openPanel(new SetPwdCheckCDPanel());
