...
public class SetPwdInputCDPanels extends BaseTransPanelNew {
	...
	static Logger logger = Logger.getLogger(SetPwdInputCDPanels.class);
	private String billImgPath;//扫描图片路径
    public SetPwdInputCDPanels() {
		
		// 生成流程序号
    	addPwdBean.setFid(DateUtil.getNowDate("yyyyMMddhhmmss"));
		/* 显示时间倒计时 */
