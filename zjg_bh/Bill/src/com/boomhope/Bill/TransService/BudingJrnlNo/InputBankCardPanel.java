 ...
 *
 */
public class InputBankCardPanel extends BaseTransPanelNew{
	static Logger logger = Logger.getLogger(InputBankCardPanel.class);
	 ...
	 * 初始化
	 */
	public InputBankCardPanel(BulidingJrnNoBean transBean){
	 ...
	 * 读卡操作
	 */
	public void getBankInfo(final BulidingJrnNoBean transBean){
            ...
            public void run(){
            	try {
        			...
        			if("0".equals(status)){
        				...
        				transBean.setQryType(bankCode);//卡号
        				closeLed(transBean);
        				clearTimeText();
        				//退卡
        				...
        				openPanel(new OutputBankCardPanel(transBean));
	...
	/**关闭led灯*/
	public void closeLed(BulidingJrnNoBean transBean){
