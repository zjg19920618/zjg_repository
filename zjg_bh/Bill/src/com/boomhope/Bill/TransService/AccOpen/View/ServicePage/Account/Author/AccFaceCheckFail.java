 ...
 *
 */
public class AccFaceCheckFail extends BaseTransPanelNew{
	private static final long serialVersionUID = 1L;
	
	Logger logger = Logger.getLogger(AccFaceCheckFail.class);
	private boolean on_off=true;
	
	public AccFaceCheckFail(final AccPublicBean AccBean,final Map map) {
		...
		AccBean.setCameraCount(String.valueOf((Integer.parseInt(AccBean.getCameraCount())+1)));
		...
		lblNewLabel.setText(setErrmsg(AccBean.getCheckFaceMsg()));
		...
		if(Property.CAMEAR_COUNT.equals(AccBean.getCameraCount())){
