 ...
 *
 */
public class AccInputIdCardPanel extends BaseTransPanelNew{
	Thread thread = null;
	static Logger logger = Logger.getLogger(AccInputIdCardPanel.class);
	IdCardReadBean bean = null;
	SourceDataLine line = null;
	JButton button  = null;
	private static final long serialVersionUID = 1L;
	public AccInputIdCardPanel(final Map map) {
		...
		thread  = new Thread("readIdCard"){
            ...
            public void run(){
        		...
        		if("0".equals(status)){
        			...
        			map.put("isMyself", "Y");//判断本人进行身份证与银行卡帐户比对
