 ...
 *
 */
public class AccPrivateLinePanel3 extends BaseTransPanelNew {

	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(AccPrivateLinePanel3.class);
	private boolean on_off=true;

	public AccPrivateLinePanel3(final Map<Object, Object> params) {
		logger.info("进入私行快线产品第三页页面");
