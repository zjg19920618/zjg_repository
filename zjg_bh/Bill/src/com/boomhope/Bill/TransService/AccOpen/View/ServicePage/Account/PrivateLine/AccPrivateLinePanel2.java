 ...
 *
 */
public class AccPrivateLinePanel2 extends BaseTransPanelNew {

	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(AccPrivateLinePanel2.class);
	private boolean on_off=true;

	public AccPrivateLinePanel2(final Map<Object, Object> params) {
		logger.info("进入私行快线产品第二页面");
	...
	public void stepPage(final Map<Object, Object> params) {
		logger.info("进入私行产品上一页的方法");
		clearTimeText();// 清空倒计时
		logger.info("进入私行产品第一页...");
		openPanel(new AccPrivateLinePanel(params));
	}
	/** 私行产品下一页*/
	public void nextPage(final Map<Object,Object> params){
		logger.info("进入私行产品的下一页方法");
		clearTimeText();//清空倒计时
		logger.info("进入私行产品第三页...");
		openPanel(new AccPrivateLinePanel3(params));
	}
	/** 返回上一步 */
