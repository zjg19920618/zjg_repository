...
public class Test0018 {
	...
	public static void main(String[] args) throws UnknownHostException, IOException {
		...
		map.put("cardNo", "6231931000000000017");//卡号
		...
		try {
			...
			BCK0018ResBean bck0018ResBean = (BCK0018ResBean)reqXs.fromXML(retMsg);
			System.out.println(bck0018ResBean);
