 ...
 */
@XStreamAlias("BODY")	
public class Out03517ReqBodyBean {
	...
	private Out03517ReqAgentInfBean AGENT_INF;//代理人信息
	...
	public Out03517ReqAgentInfBean getAGENT_INF() {
		return AGENT_INF;
	}
	public void setAGENT_INF(Out03517ReqAgentInfBean aGENT_INF) {
		AGENT_INF = aGENT_INF;
	}
