 ...
 */
@XStreamAlias("Body")
public class BCK02224ReqBodyBean {
	...
	private BCK02224ReqBodyDetailBean  DETAIL;//收款方明细
	private String TEL_NO;//手机号
	
	
	
	public BCK02224ReqBodyDetailBean getDETAIL() {
		return DETAIL;
	}

	public void setDETAIL(BCK02224ReqBodyDetailBean dETAIL) {
		DETAIL = dETAIL;
	}
