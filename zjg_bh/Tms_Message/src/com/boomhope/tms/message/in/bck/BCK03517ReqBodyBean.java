 ...
 */
@XStreamAlias("Body")	
public class BCK03517ReqBodyBean {
	...
	private BCK03517ReqAgentInfBean AGENT_INF;//代理人信息
	...
	public BCK03517ReqAgentInfBean getAGENT_INF() {
		return AGENT_INF;
	}
	public void setAGENT_INF(BCK03517ReqAgentInfBean aGENT_INF) {
		AGENT_INF = aGENT_INF;
	}
