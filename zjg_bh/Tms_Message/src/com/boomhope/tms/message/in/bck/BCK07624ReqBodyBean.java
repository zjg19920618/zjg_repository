 ...
 */
@XStreamAlias("Body")
public class BCK07624ReqBodyBean {
	...
	private BCK07624ReqAgentInfBean AGENT_INF;//代理人信息
	/*以下信息不上送前置*/
	...
	public BCK07624ReqAgentInfBean getAGENT_INF() {
		return AGENT_INF;
	}
	public void setAGENT_INF(BCK07624ReqAgentInfBean aGENT_INF) {
		AGENT_INF = aGENT_INF;
	}
