 ...
 */
@XStreamAlias("Body")	
public class BCK0021ReqBodyBean {
	...
	private BCK0021ReqAgentInfBean AGENT_INF;//代理人信息
	...
	public BCK0021ReqAgentInfBean getAGENT_INF() {
		return AGENT_INF;
	}
	public void setAGENT_INF(BCK0021ReqAgentInfBean aGENT_INF) {
		AGENT_INF = aGENT_INF;
	}
