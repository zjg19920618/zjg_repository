 ...
 */
@XStreamAlias("Body")
public class BCK0022ReqBodyBean {
	...
	private BCK0022ReqAgentInfBean AGENT_INF;//代理人信息
	...
	public BCK0022ReqAgentInfBean getAGENT_INF() {
		return AGENT_INF;
	}
	public void setAGENT_INF(BCK0022ReqAgentInfBean aGENT_INF) {
		AGENT_INF = aGENT_INF;
	}
