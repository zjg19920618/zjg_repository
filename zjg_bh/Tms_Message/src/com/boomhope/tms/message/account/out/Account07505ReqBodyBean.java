...
*/
@XStreamAlias("BODY")
public class Account07505ReqBodyBean {
	private Account07505AcctInfo ACCT_INFO;//账户信息
	...
	public Account07505AcctInfo getACCT_INFO() {
		return ACCT_INFO;
	}
	public void setACCT_INFO(Account07505AcctInfo aCCT_INFO) {
		ACCT_INFO = aCCT_INFO;
	}
