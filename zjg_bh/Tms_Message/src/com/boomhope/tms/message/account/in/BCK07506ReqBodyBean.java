...
*/
@XStreamAlias("Body")
public class BCK07506ReqBodyBean {
	...
	private BCK07506ReqAgentInfBean ACCT_INFO;//账户信息
	...
	public BCK07506ReqAgentInfBean getACCT_INFO() {
		return ACCT_INFO;
	}
	public void setACCT_INFO(BCK07506ReqAgentInfBean aCCT_INFO) {
		ACCT_INFO = aCCT_INFO;
	}
