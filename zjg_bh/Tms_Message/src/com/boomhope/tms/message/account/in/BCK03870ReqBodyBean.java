...
*/
@XStreamAlias("Body")
public class BCK03870ReqBodyBean {
	...
	private BCK03870ReqAgentInfBean AGENT_INF;//代理人信息
	...
	public BCK03870ReqAgentInfBean getAGENT_INF() {
		return AGENT_INF;
	}
	public void setAGENT_INF(BCK03870ReqAgentInfBean aGENT_INF) {
		AGENT_INF = aGENT_INF;
	}
