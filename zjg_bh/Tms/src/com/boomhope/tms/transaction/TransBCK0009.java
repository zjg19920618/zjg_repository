...
import com.boomhope.tms.message.in.bck.BCK0009ResBodyBean;
...
public class TransBCK0009 extends BaseTransaction implements ServletContextListener{
	Logger logger = Logger.getLogger(TransBCK0009.class);
	IDeployMachineService deployMachineService = null;
	ITransFlowService transFlowService;	// 交易流水服务
	BCK0009ReqBean inReqBean;	// 渠道请求Bean
	BCK0009ResBean inResBean;	// 渠道响应Bean
	...
	public String handle(String msg) {
		try {
			transFlowService = (ITransFlowService) TransBCK0009.getBean("TransFlowService");
	...
	private void addTransFlow() throws Exception {
		try {
			...
			transFlow.setTransCode("BCK_0009");
			transFlow.setTransName("回单机-柜员认证方式查询");
	...
	private String makeResErrorMsg(String msg,String service) {
		...
		inResBean = new BCK0009ResBean();
		BCK0009ResBodyBean bck0009ResBodyBean = new BCK0009ResBodyBean();
		inResBean.setBody(bck0009ResBodyBean);
	...
	private String makeResMsg() throws Exception {
		try {
			inResBean = new BCK0009ResBean();
			BCK0009ResBodyBean bck0009ResBodyBean = new BCK0009ResBodyBean();
			bck0009ResBodyBean.setCHECK_MOD(outResBean.getBODY().getCHECK_MOD());
			inResBean.setBody(bck0009ResBodyBean);
			InResHeadBean inResHeadBean = new InResHeadBean();
	...
	private byte[] makeOutReqMsg() throws Exception{
		try {
			outReqBean = new Out07659ReqBean();
			Out07659ReqBodyBean out07659ReqBodyBean = new Out07659ReqBodyBean();
			out07659ReqBodyBean.setQRY_TELLER_NO(inReqBean.getBody().getQRY_TELLER_NO());
			
			outReqBean.setBODY(out07659ReqBodyBean);
			OutHeadBean headBean = new OutHeadBean();
			headBean.setTRAN_CODE("07659");
	...
	private BCK0009ReqBean makeInReqBean(String msg) throws Exception{
		/* 解析渠道请求报文*/
		XStream reqXs = new XStream(new DomDriver("UTF-8",new XStreamNameCoder()));
		
		reqXs.alias("Root", BCK0009ReqBean.class);
		reqXs.alias("Head", InReqHeadBean.class);
		reqXs.alias("Body", BCK0009ReqBodyBean.class);
		
		return (BCK0009ReqBean)reqXs.fromXML(msg);
	}
