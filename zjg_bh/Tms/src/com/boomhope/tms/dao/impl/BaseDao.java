...
//	protected SessionFactory sessionFactory;
	...
	protected AbstractEntityPersister getPersister(Class<?> c) {
		return (AbstractEntityPersister) super.getHibernateTemplate().getSessionFactory().getClassMetadata(c);
	}
	...
	protected String transHqlToSql(String hql) {
		...
		QueryTranslatorImpl queryTranslator = new QueryTranslatorImpl(hql, hql, Collections.EMPTY_MAP, (SessionFactoryImpl) super.getHibernateTemplate().getSessionFactory()); // 得到Query转换器实现类
